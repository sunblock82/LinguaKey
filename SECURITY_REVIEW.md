...
| 배포 | 최종 release APK 디버깅 금지, 기존 설치 서명 유지, CI 보고서 보관 | apksigner 및 aapt 검사 |
...
- 공개 서비스용 인증 서버·한도 관리·영구 배포 서명키는 없습니다. 개인 API 키 방식이며 API 비용은 사용자 제공자 계정에 청구됩니다. 취소해도 이미 처리된 요청 비용은 생길 수 있습니다.
